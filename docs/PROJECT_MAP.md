...
The consolidated iOS folder now contains the complete `IlluminedIOS.xcodeproj`, its Git history, application source, tests, resources, and the Desktop project’s uncommitted work. The earlier Swift-only source tree is preserved at `archive/ios-swift-source-2026-07-30/`.
