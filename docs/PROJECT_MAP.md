...
The consolidated iOS folder now contains the complete `IlluminedIOS.xcodeproj`, its Git history, application source, tests, resources, and the Desktop project’s uncommitted work. It has been confirmed functioning in Xcode. The earlier Swift-only source tree is preserved at `archive/ios-swift-source-2026-07-30/`. An exact 170-file copy of the current Desktop working project is preserved at `archive/legacy/ios-desktop-working-copy-2026-07-30/`; the Desktop original remains in place but is eligible for explicit, recoverable retirement.
